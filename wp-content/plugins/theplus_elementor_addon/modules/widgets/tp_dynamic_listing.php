	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			array(
				...
				'separator'   => 'before',
				'condition'   => array(
					'blogs_post_listing!' => array( 'archive_listing', 'related_post', 'acf_repeater', 'custom_query' ),
					'query'               => array( 'post' ),
				),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'dynamic'     => array( 'active' => true ),
				'condition'   => array(
					'blogs_post_listing!' => array( 'archive_listing', 'related_product', 'acf_repeater', 'custom_query' ),
					'query!'              => array( 'post' ),
					'post_taxonomies!'    => '',
				),
			)
		...
		$this->add_control(
			...
			array(
				...
				'dynamic'     => array( 'active' => true ),
				'condition'   => array(
					'blogs_post_listing!' => array( 'archive_listing', 'related_post', 'acf_repeater' ),
				),
			)
		);
		$this->add_control(
		...
		$this->add_control(
			...
			array(
				...
				'condition' => array(
					'layout!'             => 'carousel',
					'blogs_post_listing!' => array( 'archive_listing', 'related_post', 'custom_query' ),
				),
			)
		);
		$this->add_control(
		...
		$this->add_control(
			...
			array(
				...
				'condition' => array(
					'layout!'             => array( 'carousel' ),
					'blogs_post_listing!' => array( 'related_post', 'custom_query' ),
				),
			)
		);
		$this->add_control(
