...
class ThePlus_Social_Feed extends Widget_Base {
	...
	public function get_keywords() {
		return array( 'Social Feed', 'Social Media Feed', 'Instagram Feed', 'Facebook Feed', 'Twitter Feed', 'Pinterest Feed', 'LinkedIn Feed', 'Social Wall', 'Social Stream', 'Social Grid', 'Social Carousel', 'Social Tiles', 'Social Widget' );
	}
	...
	protected function register_controls() {
		...
		$repeater->add_control(
			...
			array(
				...
				'condition'  => array(
					'selectFeed' => array( 'Facebook', 'Instagram' ),
				),
				'conditions' => array(
					'relation' => 'or',
					'terms'    => array(
	...
	protected function YouTubeFeed( $social ) {
		...
		if ( $HTTP_CODE == 200 ) {
			...
			foreach ( $Ytpost as $index => $YtSearch ) {
				...
				if ( 'YT_Userfeed' === $YtType || 'YT_Channel' === $YtType || 'YT_Search' === $YtType ) {
