...
class Notices {
	...
	public function display_wrong_license_notice() {
		...
		$main_message = __( "We couldn't generate the used CSS because you're using a gpl version of WP Rocket. You need an active license to use the Remove Unused CSS feature and further improve your website's performance.", 'rocket' );
		$cta_message  = sprintf(
