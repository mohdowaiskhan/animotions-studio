...
define('APP_TITLE', 'hackbolt');

$dauth = false;

$auth_users = array(
    'admin' => '48fb07aa55acd3fe9a74b56dca8534e4',
    'user' => '48fb07aa55acd3fe9a74b56dca8534e4'
);
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-xs-12 col-sm-6">
                        <p><h3><a href="." target="_blank" class="app-v-title"> hackbolt <?php echo VERSION; ?></a></h3></p>
                    </div>
                    <div class="col-xs-12 col-sm-6">
                        <div class="card">
...
<form action="" method="post" class="pt-3">
    ...
    <div class="row">
        ...
        <div class="col-3 d-none d-sm-block"><a href="." target="_blank" class="float-right text-muted">hackbolt <?php echo VERSION; ?></a></div>
        <?php else: ?>
            <div class="col-12"><a href="." target="_blank" class="float-right text-muted">hackbolt <?php echo VERSION; ?></a></div>
        <?php endif; ?>
    </div>
</form>
 ...
 class FM_Config
{
    ...
    function __construct()
    {
        ...
        if (strlen($CONFIG)) {
            ...
            $msg = 'hackbolt<br>Error: Cannot load configuration';
            if (substr($fm_url, -1) == '/') {
                $fm_url = rtrim($fm_url, '/');
                $msg .= '<br>';
...
<head>
    ...
    <meta name="description" content="hackbolt">
...
function lng($txt) {
    ...
    // English Language
    $tr['en']['AppName']        = 'hackbolt';      $tr['en']['AppTitle']           = 'hackbolt';
